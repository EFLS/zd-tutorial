...
Tags are a way to quickly retrieve a subsection of notes (for example with §2020-04-17-1608 Generating lists of links).
...
To customize this behaviour, set =zetteldeft-tag-regex=.
